...
def DetectCMS(site):
    url = Domains(site)
    Joomla = "{}/administrator/help/en-GB/toc.json".format(
        url
    )  # "COMPONENTS_BANNERS_BANNERS"
    Joomla2 = "{}/administrator/language/en-GB/install.xml".format(
        url
    )  # <author>Joomla!
    ...
    Wordpress2 = "{}/wp-includes/js/jquery/jquery.js".format(
        url
    )  # (c) jQuery Foundation
