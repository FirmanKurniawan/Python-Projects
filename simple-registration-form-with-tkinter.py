...
Label(frame1, text="Form Registrasi", font="Normal 25", bg="cyan").grid(
    row=0, column=0, columnspan=3
)  # kalau di exel columnspan itu merge/menggabungkan cell

Label(frame1, text="Username", font="Normal 15", bg="cyan").grid(
...
Radiobutton(frame1, text="Pria", variable=cmb, value=1, font="Normal 15").grid(
    row=3, column=1
)
Radiobutton(frame1, text="Wanita", variable=cmb, value=2, font="Normal 15").grid(
    row=3, column=2
)
...
data_agama = ["Islam", "Kristen", "Hindu", "Budha", "Katolik"]
Label(frame1, text="Agama", font="Normal 15").grid(row=5, column=0, pady=15)
data_combo = ttk.Combobox(
    frame1, values=data_agama, font="Normal 10", width=29, state="readonly"
)
