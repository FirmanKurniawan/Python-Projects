...
class Bill_App:
    def __init__(self, root):
        ...
        cname_lbl = Label(
            F1, text="Customer Name:", bg=bg_color, font=("times new roman", 15, "bold")
        )
        cname_lbl.grid(row=0, column=0, padx=20, pady=5)
        cname_txt = Entry(
            F1, width=15, textvariable=self.c_name, font="arial 15", bd=7, relief=GROOVE
        )
        ...
        c_bill_lbl = Label(
            F1, text="Bill Number:", bg="#badc57", font=("times new roman", 15, "bold")
        )
