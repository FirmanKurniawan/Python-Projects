...
class find:
    ...
    def results(self):
        ...
        if str(self.more) in self.req:
            ...
            self.url = "{}{}".format(self.url, self.npage[0].replace("q=", ""))
...
class get:
    def __init__(self, u):
        self.req = requests.get(
            u,
            headers={
                "User-Agent": "Mozilla/5.0 (iPhone; CPU iPhone OS 6_0 like Mac OS X) App leWebKit/536.26 (KHTML, like Gecko) Version/6.0 Mobile/10A5376e Safari/8536.25"
            },
        ).text
