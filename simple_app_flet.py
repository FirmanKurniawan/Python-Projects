...
class AppMain:
    ...
    def __init__(self, page):
        ...
        self.TextHeaderWelcome = Text(
            "สวัสดีสมาชิกทุกท่านด้วยนี่คือแอพทดสอบของ wk-18k",
            style="headlineLarge",
            text_align="center",
        )
...
class AppRegister:
    ...
    def create_form(self):
        ...
        self.SurnameInput = TextField(
            label="นามสกุล", hint_text="กรอกนามสกุล", width=300
        )
        self.AgeInput = TextField(
            label="อายุ", hint_text="อายุ", width=300, keyboard_type="number", value=0
        )
        ...
        if self.NameInput.value != "" and self.SurnameInput.value != "":
            ...
            if self.Is_has_validate_name["status_surname"] != 1:
                self.page.insert(
                    4,
                    Text(
                        "กรุณากรอกข้อมูลนามสกุลให้ครบถ้วน",
                        style="bodySmall",
                        text_align="start",
                    ),
                )
