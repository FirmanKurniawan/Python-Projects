...
frozen_model = (
    r"D:\Hacktoberfest2021-2\Python\Object Detection\Coco\frozen_inference_graph.pb"
)
out = cv.VideoWriter(
    "Result.mp4", cv.VideoWriter_fourcc(*"m", "p", "4", "v"), 20, (700, 500)
)
