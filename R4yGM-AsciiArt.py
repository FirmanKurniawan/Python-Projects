...
AsciiPy/AsciiPy.py /
@R4yGM
R4yGM Update AsciiPy.py
Latest commit 3e12dc7 on 18 Sep 2019
History
1 contributor
221 lines (171 sloc) 7.17 KB
"""
...
class AsciiImage:
    def GenerateFromUrl(self, url):
        ...
        ascii_image = [
            n_pixels[index : index + new_width]
