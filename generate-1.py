...
"""
    ...
    def doBody(self):
        ...
        for name, data in self.packages.iteritems():
            ...
            dirset = (
                {}
            )  # if python had a set-datatype this would be sufficient. for now, we're using a dict instead.
            for target in files:
...
if __name__ == "__main__":
    ...
    m.addPackage(
        0,
        "python-core-dbg",
        "Python core module debug information",
        "python-core",
    ...
    m.addPackage(
        0,
        "python-pydoc",
        "Python Interactive Help Support",
        "python-core python-lang python-stringold python-re",
        "${bindir}/pydoc pydoc.*",
    )
    ...
    m.addPackage(
        0,
        "python-smtpd",
        "Python Simple Mail Transport Daemon",
        "python-core python-netserver python-email python-mime",
        "${bindir}/smtpd.*",
    )
    ...
    m.addPackage(
        0,
        "python-bsddb",
        "Python Berkeley Database Bindings",
        "python-core",
        "bsddb lib-dynload/_bsddb.so",
    )  # package
    ...
    m.addPackage(
        0,
        "python-compile",
        "Python Bytecode Compilation Support",
        "python-core",
        "py_compile.* compileall.*",
    )

    m.addPackage(
        0, "python-compiler", "Python Compiler Support", "python-core", "compiler"
    )  # package

    m.addPackage(
        0,
        "python-compression",
        "Python High Level Compression Support",
        "python-core python-zlib",
    ...
    m.addPackage(
        0,
        "python-crypt",
        "Python Basic Cryptographic and Hashing Support",
        "python-core",
    ...
    m.addPackage(
        0,
        "python-textutils",
        "Python Option Parsing, Text Wrapping and Comma-Separated-Value Support",
        "python-core python-io python-re python-stringold",
    ...
    m.addPackage(
        0,
        "python-ctypes",
        "Python C Types Support",
        "python-core",
        "ctypes lib-dynload/_ctypes.so",
    )  # directory + low level module

    m.addPackage(
        0,
        "python-datetime",
        "Python Calendar and Time support",
        "python-core python-codecs",
    ...
    m.addPackage(
        0,
        "python-db",
        "Python File-Based Database Support",
        "python-core",
    ...
    m.addPackage(
        ...
        "python-debugger",
        "Python Debugger",
        "python-core python-io python-lang python-re python-stringold python-shell python-pprint",
        "bdb.* pdb.*",
    )
    ...
    m.addPackage(
        0,
        "python-difflib",
        "Python helpers for computing deltas between objects.",
        "python-lang python-re",
        "difflib.*",
    )
    ...
    m.addPackage(
        0,
        "python-doctest",
        "Python framework for running examples in docstrings.",
        "python-core python-lang python-io python-re python-unittest python-debugger python-difflib",
        "doctest.*",
    )
    ...
    m.addPackage(
        0,
        "python-email",
        "Python Email Support",
        "python-core python-io python-re python-mime python-audio python-image",
        "email",
    )  # package
    ...
    m.addPackage(
        0,
        "python-image",
        "Python Graphical Image Handling",
        "python-core",
    ...
    m.addPackage(
        0,
        "python-io",
        "Python Low-Level I/O",
        "python-core python-math",
    ...
    m.addPackage(
        ...
        "python-core python-io python-lang python-pickle python-stringold",
        "logging",
    )  # package
    ...
    m.addPackage(
        ...
        "python-core",
        "lib-dynload/_tkinter.so lib-tk",
    )  # package
    ...
    m.addPackage(
        0,
        "python-mime",
        "Python MIME Handling APIs",
        "python-core python-io",
    ...
    m.addPackage(
        0,
        "python-mmap",
        "Python Memory-Mapped-File Support",
        "python-core python-io",
        "lib-dynload/mmap.so ",
    )
    ...
    m.addPackage(
        0,
        "python-unixadmin",
        "Python Unix Administration Support",
        "python-core",
    ...
    m.addPackage(
        0,
        "python-netclient",
        "Python Internet Protocol Clients",
        "python-core python-crypt python-datetime python-io python-lang python-logging python-mime",
        "*Cookie*.* "
    ...
    m.addPackage(
        0,
        "python-netserver",
        "Python Internet Protocol Servers",
        "python-core python-netclient",
    ...
    m.addPackage(
        0,
        "python-pickle",
        "Python Persistence Support",
        "python-core python-codecs python-io python-re",
    ...
    m.addPackage(
        0,
        "python-pkgutil",
        "Python Package Extension Utility Support",
        "python-core",
        "pkgutil.*",
    )

    m.addPackage(
        0, "python-pprint", "Python Pretty-Print Support", "python-core", "pprint.*"
    )

    m.addPackage(
        0,
        "python-profile",
        "Python Basic Profiling Support",
        "python-core python-textutils",
    ...
    m.addPackage(
        0,
        "python-re",
        "Python Regular Expression APIs",
        "python-core",
        "re.* sre.* sre_compile.* sre_constants* sre_parse.*",
    )  # _sre is builtin
    ...
    m.addPackage(
        0,
        "python-resource",
        "Python Resource Control Interface",
        "python-core",
    ...
    m.addPackage(
        0,
        "python-shell",
        "Python Shell-Like Functionality",
    ...
    m.addPackage(
        ...
        "python-core python-io python-re python-fcntl python-pickle",
        "subprocess.*",
    )
    ...
    m.addPackage(
        0,
        "python-sqlite3",
        "Python Sqlite3 Database Support",
        "python-core python-datetime python-lang python-crypt python-io python-threading python-zlib",
    ...
    m.addPackage(
        ...
        "Python Sqlite3 Database Support Tests",
    ...
    m.addPackage(
        0,
        "python-terminal",
        "Python Terminal Controlling Support",
        "python-core python-io",
        "pty.* tty.*",
    )

    m.addPackage(0, "python-tests", "Python Tests", "python-core", "test")  # package

    m.addPackage(
        0,
        "python-threading",
        "Python Threading & Synchronization Support",
        "python-core python-lang",
    ...
    m.addPackage(
        ...
        "python-core python-stringold python-lang",
        "unittest.*",
    )
    ...
    m.addPackage(
        0,
        "python-xml",
        "Python basic XML support.",
        "python-core python-re",
        "lib-dynload/pyexpat.so xml xmllib.*",
    )  # package

    m.addPackage(
        0,
        "python-xmlrpc",
        "Python XMLRPC Support",
        "python-core python-xml python-netserver python-lang",
        "xmlrpclib.* SimpleXMLRPCServer.*",
    )

    m.addPackage(
        0, "python-zlib", "Python zlib Support.", "python-core", "lib-dynload/zlib.so"
    )

    m.addPackage(
        0,
        "python-mailbox",
        "Python Mailbox Format Support",
        "python-core python-mime",
        "mailbox.*",
    )

    # FIXME consider adding to python-compression
    m.addPackage(
        0, "python-bzip2", "Python bzip2 support", "python-core", "lib-dynload/bz2.so"
    )
