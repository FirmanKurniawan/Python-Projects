...
class Student:
    ...
    def check_status(self):
        ...
        percentage = (
            (self.maths + self.english + self.chem + self.phy + self.computer) * 100
        ) / 500
        total = self.maths + self.english + self.chem + self.phy + self.computer
        if (
            (self.phy and self.chem and self.maths and self.computer and self.english)
            > 33
            and percentage > 90
            and percentage < 100
        ):
