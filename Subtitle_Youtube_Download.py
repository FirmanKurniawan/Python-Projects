...
class App(tk.Tk):
    ...
    def WidgetSetup(self):
        ...
        self.TextTopView = Label(
            self, text="ใส่ลิงก์ Youtube ลงไป", font=("Helvetica", 20)
        ).place(x=250, y=25, anchor="center")
        self.Button = Button(
            self,
            text="ค้นหาซับ",
            width=8,
            font=("Helvetica", 15),
            command=self.finding,
            bg="#24d6d1",
            fg="white",
        )
        ...
        self.Button2 = Button(
            ...
            width=15,
            font=("Helvetica", 10),
            command=lambda: os.startfile("Subtitle"),
        )
    ...
    def finding(self):
        ...
        if self.URL.get() == "":
            ...
            Label(self, text=f"ภาษาในซับแล้วรหัส                          ").place(
                x=65, y=150
            )
            try:
                ...
                Label(self, text=f"{self.yt.title[0:30]} {self.yt.title[-5:-1]}").place(
                    x=250, y=25, anchor="center"
                )
                self.OPTION = []
                ...
                for i in range(1, self.yt.captions.__len__() + 1):
                    ...
                    self.Mylabeldata = Label(
                        self,
                        text=f"ภาษา {self.yt.captions.all()[i].name} รหัส {self.yt.captions.all()[i].code}",
                    ).place(x=65, y=150 + (30 * i))
    ...
    def DropDown(self):
        ...
        Label(self, text="เลือกภาษา", font=("Helvetica", 15)).place(
            x=80, y=120, anchor="center"
        )
        self.LocalDropDown = OptionMenu(
            self, self.option_local, *self.OPTION, command=self.callbackSelectLocal
        )
    ...
    def menubar(self):
        ...
        self.TextEng = self.langmenu.add_command(
            label="English", command=self.changeENG
        )
